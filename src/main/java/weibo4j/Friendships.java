...
public class Friendships extends Weibo {
	 ...
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/friendships/friends">friendships/friends</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/friendships/friends/in_common">friendships/friends/in_common</a>
	 * @since JDK 1.5
	 */
	public UserWapper getFriendsInCommon(String uid) throws WeiboException {
		return User
				.constructWapperUsers(client.get(WeiboConfig.getValue("baseURL") + "friendships/friends/in_common.json",
	...
	public UserWapper getFriendsInCommon(String uid, String suid, Paging page) throws WeiboException {
		return User
				.constructWapperUsers(client.get(WeiboConfig.getValue("baseURL") + "friendships/friends/in_common.json",
						new PostParameter[] { new PostParameter("uid", uid), new PostParameter("suid", suid) }, page));
	}
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/friendships/friends/bilateral">friendships/friends/bilateral</a>
	 * @since JDK 1.5
	 */
	public UserWapper getFriendsBilateral(String uid) throws WeiboException {
		return User
				.constructWapperUsers(client.get(WeiboConfig.getValue("baseURL") + "friendships/friends/bilateral.json",
						new PostParameter[] { new PostParameter("uid", uid) }));
	}
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/friendships/friends/bilateral/ids">friendships/friends/bilateral/ids</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/friendships/friends/ids">friendships/friends/ids</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/friendships/friends/remark_batch">friendships/friends/remark_batch</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/friendships/followers">friendships/followers</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/friendships/followers/ids">friendships/followers/ids</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/friendships/followers/active">friendships/followers/active</a>
	 * @since JDK 1.5
	 */
	public UserWapper getFollowersActive(String uid) throws WeiboException {
		return User
				.constructWapperUsers(client.get(WeiboConfig.getValue("baseURL") + "friendships/followers/active.json",
						new PostParameter[] { new PostParameter("uid", uid) }));
	}
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/friendships/friends_chain/followers">friendships/friends_chain/followers</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/friendships/create">friendships/create</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/friendships/destroy">friendships/destroy</a>
	 * @since JDK 1.5
	 */
