...
public class Timeline extends Weibo {
	 ...
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/statuses/public_timeline">statuses/public_timeline
	 *      </a>
	 * @since JDK 1.5
	 */
	public StatusWapper getPublicTimeline() throws WeiboException {
		return Status
				.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "statuses/public_timeline.json"));
	}
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/statuses/user_timeline">statuses/user_timeline</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/statuses/repost_timeline">statuses/repost_timeline</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/statuses/repost_timeline/ids">statuses/repost_timeline/ids</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/statuses/repost_by_me">statuses/repost_by_me</a>
	 * @since JDK 1.5
	 */
	...
	public StatusWapper getRepostByMe(Paging page) throws WeiboException {
		return Status.constructWapperStatus(
				client.get(WeiboConfig.getValue("baseURL") + "statuses/repost_by_me.json", null, page));
	}
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/statuses/mentions">statuses/mentions</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.1
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/statuses/mentions/ids">statuses/mentions/ids</a>
	 * @since JDK 1.5
	 */
	...
	public JSONObject getMentionsIds(Paging page, Integer filter_by_author, Integer filter_by_source,
			Integer filter_by_type) throws WeiboException {
		return client
				.get(WeiboConfig.getValue("baseURL") + "statuses/mentions/ids.json",
						new PostParameter[] { new PostParameter("filter_by_author", filter_by_author.toString()),
								new PostParameter("filter_by_source", filter_by_source.toString()),
								new PostParameter("filter_by_type", filter_by_type.toString()) },
						page)
	 ...
	 * @version weibo4j-V2 1.0.1
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/statuses/bilateral_timeline">statuses/bilateral_timeline</a>
	 * @since JDK 1.5
	 */
	public StatusWapper getBilateralTimeline() throws WeiboException {
		return Status.constructWapperStatus(
				client.get(WeiboConfig.getValue("baseURL") + "statuses/bilateral_timeline.json"));
	}
	 ...
	 * @version weibo4j-V2 1.0.1
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/statuses/show">statuses/show</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/statuses/querymid">statuses/querymid</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/statuses/queryid">statuses/queryid</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/statuses/hot/repost_daily">statuses/hot/repost_daily</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/statuses/repost">statuses/repost</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/statuses/destroy">statuses/destroy</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/statuses/update">statuses/update</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/statuses/upload">statuses/upload</a>
	 * @since JDK 1.5
	 */
