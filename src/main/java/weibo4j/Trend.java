...
public class Trend extends Weibo {
	 ...
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/trends/is_follow">trends/is_follow</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @throws JSONException
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/trends/hourly">trends/hourly</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @throws JSONException
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/trends/weekly">trends/weekly</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @throws JSONException
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/trends/follow">trends/follow</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @throws JSONException
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/trends/destroy">trends/destroy</a>
	 * @since JDK 1.5
	 */
