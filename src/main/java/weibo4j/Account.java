...
public class Account extends Weibo {
	 ...
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/account/get_uid">account/get_uid</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.1
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/account/get_privacy">account/get_privacy</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.1
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/account/profile/school_list">account/profile/school_list</a>
	 * @since JDK 1.5
	 */
	 ...
	 * @version weibo4j-V2 1.0.1
	 * @see <a href=
	 *      "http://open.weibo.com/wiki/2/account/rate_limit_status">account/rate_limit_status</a>
	 * @since JDK 1.5
	 */
